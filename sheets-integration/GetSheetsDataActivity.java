...
//    private static double TEMP_EXT_MAX;
//    private static double TEMP_EXT_MIN;
...
//                TEMP_EXT_MAX = Double.parseDouble(tempList.get(LIST_SIZE).get(3).toString());
//                TEMP_EXT_MIN = Double.parseDouble(tempList.get(LIST_SIZE).get(3).toString());
            }
...
//                if (Double.parseDouble(tempList.get(i).get(3).toString()) > TEMP_MIN)
//                    TEMP_EXT_MAX = Double.parseDouble(tempList.get(i).get(3).toString());
//                if (Double.parseDouble(tempList.get(i).get(3).toString()) < TEMP_EXT_MIN)
//                    TEMP_EXT_MIN = Double.parseDouble(tempList.get(i).get(3).toString());
            }
...
//            intent.putExtra("TEMP_EXT_MAX", Double.toString(TEMP_EXT_MAX));
//            intent.putExtra("TEMP_EXT_MIN", Double.toString(TEMP_EXT_MIN));
